...
public class MapsActivity extends FragmentActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tmpPosition = new LatLng(47, 19);
        mMap.addMarker(new MarkerOptions().position(tmpPosition).title(
                "Marker message"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(tmpPosition));
